...
Route::get('/academic/discipline', 'Web\WebsiteController@registrationAdmission')->name('web.reg_admission');
...
Route::get('/hostels', 'Web\WebsiteController@hostels')->name('web.hostels');
Route::get('/library', 'Web\WebsiteController@library')->name('web.library');
Route::get('/committee', 'Web\WebsiteController@committee')->name('web.committee');
