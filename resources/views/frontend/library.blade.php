 ...
 <div class="inner-page-banner-area">
     <div class="container">
         <div class="pagination-area">
             <h1 style="text-align: center;">Library & Lab</h1>
         ...
         <div class="row about-page2-inner">
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="about-page-img-holder ">
                <strong>Library:</strong> The Academy has well equipped library having necessary text books, reference book, magazines, news papers, journals, story books, novel etc. for the students and teachers.
                Students have to produce library card for any books to be issued to them.            
               </div><br>
               <strong>Laboratory:</strong>  The academy has well equipped laboratory with all the facilities separately for chemistry, physics and biology. The laboratory can be accommodated for forty students at a time to perform practical experiment.
           </div>
         </div>
     </div>
 </div>
