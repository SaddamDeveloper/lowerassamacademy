    ...
    <div class="row">
            ...
            <div class="col-md-12" style="margin-top:50px;">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Gallery List</h2>
                        <a class="btn btn-primary pull-right" href="{{route('admin.add_gallery_form')}}">Add Gallery</a>
    ...
    <script>
        $(function(){
            var table = $('#notice_list').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.get_gallery_list') }}",
                columns: [
                    {data: 'id', name: 'id',searchable: true},
                    {data: 'title', name: 'title',searchable: true},      
                    {data: 'gallery', name: 'gallery',searchable: true},      
